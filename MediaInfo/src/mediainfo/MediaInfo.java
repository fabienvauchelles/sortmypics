...
public class MediaInfo
{
    ...
    //Internal stuff
    interface MediaInfoInternal
            extends Library
    {
        public static MediaInfoInternal INSTANCE = (MediaInfoInternal) Native.loadLibrary( "mediainfo" ,
                                                                                           MediaInfoInternal.class ,
        ...
        WString GetI( Pointer Handle ,
                      int StreamKind ,
                      int StreamNumber ,
                      int parameterIndex ,
                      int infoKind );

        int Count_Get( Pointer Handle ,
                       int StreamKind ,
                       int StreamNumber );

        //Options
        WString Option( Pointer Handle ,
                        WString option ,
                        WString value );
    }
    ...
    public MediaInfo()
    {
        Handle = MediaInfoInternal.INSTANCE.New();
    }
    ...
    public void dispose()
    {
        ...
        MediaInfoInternal.INSTANCE.Delete( Handle );
        Handle = null;
    }
    ...
    {
        return MediaInfoInternal.INSTANCE.Open( Handle ,
                                                new WString( File_Name ) );
    }
    ...
    public void Close()
    {
        MediaInfoInternal.INSTANCE.Close( Handle );
    }
    ...
    {
        return MediaInfoInternal.INSTANCE.Inform( Handle ).toString();
    }
     ...
     * @param parameter Parameter you are looking for in the Stream (Codec, width, bitrate...), in string format ("Codec",
     * "Width"...)
     * @return a string about information you search, an empty string if there is a problem
     */
    public String Get( StreamKind StreamKind ,
                       int StreamNumber ,
                       String parameter )
    {
        return Get( StreamKind ,
                    StreamNumber ,
                    parameter ,
                    InfoKind.Text ,
                    InfoKind.Name );
    ...
    public String Get( StreamKind StreamKind ,
                       ...
                       InfoKind searchKind )
    {
        return MediaInfoInternal.INSTANCE.Get( Handle ,
                                               StreamKind.ordinal() ,
                                               StreamNumber ,
     ...
     * @param StreamKind Kind of Stream (general, video, audio...)
     * @param StreamNumber Stream number in Kind of Stream (first, second...)
     * @param parameter Parameter you are looking for in the Stream (Codec, width, bitrate...), in integer format (first
    ...
    public String Get( StreamKind StreamKind ,
                       ...
                       InfoKind infoKind )
    {
        return MediaInfoInternal.INSTANCE.GetI( Handle ,
                                                StreamKind.ordinal() ,
                                                StreamNumber ,
                                                parameterIndex ,
    ...
    {
        return MediaInfoInternal.INSTANCE.Count_Get( Handle ,
                                                     StreamKind.ordinal() ,
                                                     -1 );
    }
    ...
    {
        return MediaInfoInternal.INSTANCE.Option( Handle ,
                                                  new WString( Option ) ,
    ...
    {
        return MediaInfoInternal.INSTANCE.Option( MediaInfoInternal.INSTANCE.New() ,
                                                  new WString( Option ) ,
                                                  new WString( "" ) ).toString();
    }
